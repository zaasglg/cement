...
import { adminCreateProcurement } from "@/lib/api/admin.functions";
...
export const Route = createFileRoute("/admin/procurements/new")({
...
function NewProcurement() {
  ...
  const [form, setForm] = useState<Procurement>(EMPTY);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSaving(true);
    try {
      await adminCreateProcurement({ data: form });
    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="sticky top-0 z-10 flex items-center justify-between border-b border-border bg-background/95 backdrop-blur px-6 py-3">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="font-medium">Новая закупка</span>
        </div>
        ...
        <FormSection title="Идентификатор">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="avto-dostavka-sever"
            />
          </div>
        </FormSection>
